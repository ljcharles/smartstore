<?php
    //je pr�fere ne pas fermer la balise php au cas o� si on a des espaces cela causerait des probs :v
    ...
    function logged_only(){
        ...
        if(!isset($_SESSION['auth'])){
            $_SESSION['flash']['danger'] = 'Vous n\'avez pas le droit d\'acc�der � cette page. Connectez-vous d\'abord!';
